...
**Primary sources (vLLM, engine and docs, plus hardware specifications — read at tag `v0.27.1`, cross-checked against `main` @ `c1e4387`, 2026-08-17)**
