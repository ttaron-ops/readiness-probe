...
**Primary sources — Kubernetes HPA (read from `kubernetes/kubernetes` on `master`)**
...
**Primary sources — KEDA (read from `kedacore/keda` @ `d2634e6`, 2026-08-17, v2.20.x line)**
...
**Primary sources — vLLM (v0.27.1, cross-checked against `main` @ `c1e4387`)**
