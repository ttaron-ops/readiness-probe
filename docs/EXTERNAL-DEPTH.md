...
1. **[The no-hardware GPU fleet lab](../platform-eng/modules/04-gpu-on-kubernetes/practice/fake-gpu-fleet/)** —
...
2. **[`platform/03` lesson 10 — the telemetry lakehouse](../platform-eng/platform/03-observability/lessons/10-telemetry-lakehouse.md)** —
...
3. **[The design-drill ladder](../platform-eng/platform/01-distributed-systems-and-design/practice/staff-design-portfolio/design-drills.md)** —
...
|---|---|---|
| [01 Go for infra](../platform-eng/modules/01-go-for-infra/resources/depth-map.md) | ↗ | *thin* — the source is Python-first; use `k8s-learn/controller-tasks.md` for client-go practice |
| [01b Linux internals](../platform-eng/modules/01b-linux-internals/resources/depth-map.md) | ↗ | `python-mastery/06–12` (processes, virtual memory, allocators, syscalls, IPC, observing a process) + `kubernetes/00` |
| [02 K8s controllers](../platform-eng/modules/02-kubernetes-controllers/resources/depth-map.md) | ↗ | `kubernetes/04, 05, 08, 23, 24, 36` — etcd, apiserver, client-go, controller-runtime, aggregation, GC |
| [02b Host topology](../platform-eng/modules/02b-host-topology/resources/depth-map.md) | ↗ | `kubernetes/10, 21` + `python-mastery/01, 07` (NUMA, cache, page tables) |
| [03 GPU hardware](../platform-eng/modules/03-gpu-hardware/resources/depth-map.md) | ↗ | `gpu-observability/00` (how GPUs work, for observability people) |
| [04 GPU on Kubernetes](../platform-eng/modules/04-gpu-on-kubernetes/resources/depth-map.md) | ↗ | `kubernetes/10` (device manager), `19` (CSI), `21` (QoS), `k8s-learn/gpu-platform-tasks.md` |
| [05 GPU observability](../platform-eng/modules/05-gpu-observability/resources/depth-map.md) | ↗ | the whole `gpu-observability/` track — near-1:1, plus appendices B (field IDs) and C (flowcharts) |
| [06 Scheduling & capacity](../platform-eng/modules/06-scheduling-capacity/resources/depth-map.md) | ↗ | `kubernetes/09, 34, 22, 35` — scheduler internals, scheduler framework, autoscaling, 15k-node tuning |
| [07 Inference serving](../platform-eng/modules/07-inference-serving/resources/depth-map.md) | ↗ | `gpu-observability/14`, `sre-observability/26`, `ai-rag/` (adjacent) |
| [08 Distributed training](../platform-eng/modules/08-distributed-training/resources/depth-map.md) | ↗ | `gpu-observability/15`, `databases/14` (WAL — the checkpoint-durability analogue) |
| [09 Networking & topology](../platform-eng/modules/09-networking-topology/resources/depth-map.md) | ↗ | `kubernetes/15, 16` (CNI, Cilium/eBPF), `sre-observability/24` |
| [10 Bare metal & lifecycle](../platform-eng/modules/10-bare-metal-lifecycle/resources/depth-map.md) | ↗ | `kubernetes/04, 32, 33, 37` + `databases/12, 14, 16` (replication, WAL, leader election) |
| [11 GPU cost economics](../platform-eng/modules/11-gpu-cost-economics/resources/depth-map.md) | ↗ | `gpu-observability/12, 17`, `sre-observability/18, 31, 39` |
| [12 Capstone & interview](../platform-eng/modules/12-capstone-interview/resources/depth-map.md) | ↗ | `SYSTEM-DESIGN-GUIDE.md`, `tasks/`, `solutions/`, `implementation/`, `kubernetes/38` |

### Track A — Platform excellence

| Module | Depth map | Densest source material |
|---|---|---|
| [01 Distributed systems & design](../platform-eng/platform/01-distributed-systems-and-design/resources/depth-map.md) | ↗ | `databases/05, 12, 13, 14, 16, 19` + `distributed-systems/README.md` + `SYSTEM-DESIGN-GUIDE.md` |
| [02 Platform networking](../platform-eng/platform/02-platform-networking/resources/depth-map.md) | ↗ | `kubernetes/14–18, 20` — kube-proxy, CNI, Cilium/eBPF, Gateway/mesh, DNS, NetworkPolicy |
| [03 Observability](../platform-eng/platform/03-observability/resources/depth-map.md) | ↗ | the whole `sre-observability/` track — 47 chapters, the deepest single match in the repo |
