...
- **Phase:** Phase 4 · **deferrable stretch** · **Est. effort:** ~50 hrs ≈ 4–5 weeks (cheap VMs)
...
| # | Lesson | Hrs | Decision |
|---|--------|-----|----------|
| 01 | [Cluster provisioning: build one by hand](lessons/01-cluster-provisioning.md) | 8 | name every cert; KTHW then kubeadm-diff |
| 02 | [**etcd operations**](lessons/02-etcd-operations.md) (anchor) | 8 | RTO of the whole control plane |
| 03 | [Control-plane HA & upgrades](lessons/03-control-plane-ha.md) | 6 | stacked vs external etcd; VIP; skew order |
| 04 | [Declarative fleets: Cluster API + Talos](lessons/04-declarative-fleets-capi-talos.md) | 6 | hand-built → declarative fleet |
| 05 | [Node provisioning: PXE → image → firmware](lessons/05-node-provisioning-pxe.md) | 5 | netboot-to-ready pipeline |
| 06 | [Hardware health, remediation & RMA](lessons/06-hardware-health-remediation-rma.md) | 5 | close the NPD → drain → RMA loop |
| 07 | [Storage for AI](lessons/07-storage-for-ai.md) | 5 | keep expensive GPUs fed |
| 08 | [**Capex-vs-cloud economics** + LB](lessons/08-capex-vs-cloud-and-lb.md) (capstone) | 8 | build-vs-buy; the CFO conversation |

Total ≈ **50 hrs ≈ 4–5 weeks**. **Non-deferrable core:** L1 (hand-built), L2 (etcd ops), L8 (capex model).
