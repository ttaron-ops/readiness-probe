...
- [NVIDIA/nccl#584](https://github.com/NVIDIA/nccl/issues/584) and [pytorch/pytorch#43546](https://github.com/pytorch/pytorch/issues/43546) — real, filed GitHub issues documenting NCCL's hang-not-error failure mode on version/config mismatch.
